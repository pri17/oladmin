...
angular.module('ciApp').controller('runningCtrl', ['$scope', 'ServiceTask' , function($scope, ServiceTask){
       ...
       $scope.value=[];
        $scope.taskRuning = function(){
            var promesa = ServiceTask.getRunning('taskRunning');

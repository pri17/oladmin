...
angular.module('ciApp').controller('groupsManageCtrl', ['$scope', '$filter', '$mdToast', '$mdDialog', 'ServiceGroups', '$state',
    function($scope, $filter, $mdToast, $mdDialog, ServiceSetup, $state){
